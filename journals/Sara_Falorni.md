...
### 30/04/2026
I choose to use structurizr lite and plantuml to model the diagrams. I worked on the system context diagram using the guide questions from the Visualization.pdf from the lectures. I looked up how physics engine library usually interact with hardware etc. to undestand how to model it. First draft of context diagram is finalized. I started working on the component diagram.I'm finding it difficult how to model it since i can't really identify independently deployable units in the library.
